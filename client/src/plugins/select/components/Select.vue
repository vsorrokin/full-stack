<template>
  <label>
    <span class="select-title" v-if="inputLabel">{{inputLabel}}</span>
      ...
      <transition :name="transition">
        <ul ref="dropdownMenu" v-if="dropdownOpen" class="dropdown-menu" :style="{ 'max-height': maxHeight }">
          <li v-for="(option, index) in filteredOptions" :key="index" :class="{ active: isOptionSelected(option), highlight: index === typeAheadPointer }" @mouseover="typeAheadPointer = index">
            <a @mousedown.prevent="select(option)" :disabled="option.disabled">
              <span v-if="option.disabledExplanation" class="disabled-explanation">{{option.disabledExplanation}}</span>
